...
public class MyWallapopTests {
	...
	PO_RegisterView.fillForm(driver, "77777775A", "Josefo", "Perez", "77777", "77777");
    ...
    @Test
    public void PR08() {
	// Vamos al formulario de logueo. alumno
	PO_NavView.clickOption(driver, "login", "class", "btn btn-primary");
	// Rellenamos el formulario
    ...
    @Test
    public void PR09() {
	// Vamos al formulario de logueo. //profesor
	PO_NavView.clickOption(driver, "login", "class", "btn btn-primary");
	// Rellenamos el formulario
    ...
    @Test
    public void PR10() {
	// Vamos al formulario de logueo. //alumno error
	PO_NavView.clickOption(driver, "login", "class", "btn btn-primary");
	// Rellenamos el formulario
    ...
    @Test
    public void PR11() {
	// Vamos al formulario de logueo. //alumno y logout
	PO_NavView.clickOption(driver, "login", "class", "btn btn-primary");
	// Rellenamos el formulario
	PO_LoginView.fillForm(driver, "99999990A", "123456");
